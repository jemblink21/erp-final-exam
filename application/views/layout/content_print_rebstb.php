...
<body>
	...
	<div id="page-wrap">
		<div style="clear:both"></div>
            ...
            Return Pengeluaran Barang <br>
            
            <table id="supplier">
				<tbody>
					<tr>
					<?php foreach ($data as $rebstb) { ?>
							<td>No. BSTB</td>
							<td>:</td>
							<td><?php echo $rebstb['no_bstb'];?></td>
                    </tr>
				</tbody>
			</table>
			</div>
			...
			<table id="meta">
                <tr>
                    <td class="meta-head">No. REBSTB</td>
                    <td>
                        <?php echo $rebstb['no_rebstb']; ?>
                    </td>
                </tr>
                <tr>
                    <td class="meta-head">Lokasi Gudang</td>
                    <td><?php echo $rebstb['nama_gudang'];?>
                </tr>
                <tr>
                    <td class="meta-head">Departemen</td>
                    <td><?php echo $rebstb['nama_departemen'];?>
                </tr>
                <tr>
                    <td class="meta-head">Yang Menyerahkan</td>
                    <td><?php echo $rebstb['nama_pegawai'];?>
                </tr>
                <tr>
                    <td class="meta-head">Tanggal</td>
                    <td>
                    <?php 
                        $tanggal = strtotime($rebstb['tanggal']);
                ...
                <tr>
                    ...
                    <td><?php echo $rebstb['keterangan']; ?></td>
                </tr>
            <?php } ?>
			</table>
		<table id="items">
