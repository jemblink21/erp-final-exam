    ...
    <div class="col-md-12 col-sm-12 col-xs-12"><!--awal div sub kotak -->
      <div class="x_panel"><!-- awal div x_panel -->
        <div class="x_title"><!-- awal div x_title -->
          <h2>Daftar Permintaan Pembelian Barang</h2>
        ...
        <div class="x_content"><!-- awal div x_content -->
          <form action="<?php echo site_url('report/print_ppb');?>" method="POST" id="form" class="form-horizontal form-label-left" target="_blank" novalidate>
            ...
            <div class="item form-group">
              <label class="control-label col-md-3 col-sm-3 col-xs-12" for="gudang">Lokasi Gudang <span class="required">*</span></label>
              <div class="col-md-3 col-sm-3 col-xs-6">
                <select class="form-control select2_single" id="gudang" name="gudang" style="width:100%;">
                    <option></option>
                    <option value="">% - Semua Gudang</option>
                    <?php foreach ($data as $gudang) { ?>
...
<!-- footer content -->
    ...
    <script>
      ...
      function lihat(){
          $.ajax({
            url : "<?php echo site_url('report/print_ppb/')?>",
            type: "POST",
            data: $('#form').serialize(),
            dataType: "JSON",
