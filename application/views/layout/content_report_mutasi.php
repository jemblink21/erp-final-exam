    ...
    <div class="col-md-12 col-sm-12 col-xs-12"><!--awal div sub kotak -->
      <div class="x_panel"><!-- awal div x_panel -->
        ...
        <div class="x_content"><!-- awal div x_content -->
          <form action="<?php echo site_url('report/print_mutasi');?>" method="POST" id="form" class="form-horizontal form-label-left" target="_blank" novalidate>
