    ...
    <div class="col-md-12 col-sm-12 col-xs-12"><!--awal div sub kotak -->
      <div class="x_panel"><!-- awal div x_panel -->
        <div class="x_title"><!-- awal div x_title -->
          <h2>Purchase Order Outstanding Report</h2>
        ...
        <div class="x_content"><!-- awal div x_content -->
          <form action="<?php echo site_url('report/print_po_outstanding');?>" method="POST" id="form" class="form-horizontal form-label-left" target="_blank" novalidate>
